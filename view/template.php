...
<html lang="en">
  ...
  <head>
    ...
    <link href="/test2/css/clean-blog.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="/test2/view/home.php">BERG Johan</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="/test2/view/home.php">Accueil</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/test2/view/about.php">à propos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/test2/">Blog</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <script src="/test2/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
